  ...
  return (
    <View style={[styles.root, { backgroundColor: bg }]}>
      ...
      >
        ...
        >
          <Text style={[styles.heading, { fontFamily: diffuse ? diffuseFont.display : font.display, color: ink }]}>{t('auth_reset_heading')}</Text>
          <Text style={[styles.headingItalic, { fontFamily: diffuse ? diffuseFont.italic : font.italic, color: ink }]}>{t('auth_reset_heading2')}</Text>
