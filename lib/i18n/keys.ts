...
export interface TranslationKeys {
  ...
  // ─── Badges & Rewards ──────────────────────────────────────────────────
  badges_title: string
  badge_streak_3_name: string
  badge_streak_3_desc: string
  badge_streak_7_name: string
  badge_streak_7_desc: string
  badge_streak_14_name: string
  badge_streak_14_desc: string
  badge_streak_21_name: string
  badge_streak_21_desc: string
  badge_streak_30_name: string
  badge_streak_30_desc: string
  badge_streak_60_name: string
  badge_streak_60_desc: string
  badge_streak_100_name: string
  badge_streak_100_desc: string
  badge_nutrition_first_name: string
  badge_nutrition_first_desc: string
  badge_nutrition_variety_name: string
  badge_nutrition_variety_desc: string
  badge_nutrition_master_name: string
  badge_nutrition_master_desc: string
  badge_nutrition_100_name: string
  badge_nutrition_100_desc: string
  badge_sleep_first_name: string
  badge_sleep_first_desc: string
  badge_sleep_week_name: string
  badge_sleep_week_desc: string
  badge_sleep_master_name: string
  badge_sleep_master_desc: string
  badge_mood_first_name: string
  badge_mood_first_desc: string
  badge_mood_week_name: string
  badge_mood_week_desc: string
  badge_mood_happy_name: string
  badge_mood_happy_desc: string
  badge_health_vaccine_name: string
  badge_health_vaccine_desc: string
  badge_health_all_vax_name: string
  badge_health_all_vax_desc: string
  badge_health_checkup_name: string
  badge_health_checkup_desc: string
  badge_diaper_first_name: string
  badge_diaper_first_desc: string
  badge_diaper_week_name: string
  badge_diaper_week_desc: string
  badge_diaper_100_name: string
  badge_diaper_100_desc: string
  badge_growth_first_name: string
  badge_growth_first_desc: string
  badge_growth_tracker_name: string
  badge_growth_tracker_desc: string
  badge_community_first_name: string
  badge_community_first_desc: string
  badge_community_helpful_name: string
  badge_community_helpful_desc: string
  badge_community_leader_name: string
  badge_community_leader_desc: string
  badge_milestone_first_log_name: string
  badge_milestone_first_log_desc: string
  badge_milestone_first_photo_name: string
  badge_milestone_first_photo_desc: string
  badge_milestone_100_logs_name: string
  badge_milestone_100_logs_desc: string
  badge_milestone_500_logs_name: string
  badge_milestone_500_logs_desc: string
  badge_daily_checkin_7_name: string
  badge_daily_checkin_7_desc: string
  badge_daily_checkin_30_name: string
  badge_daily_checkin_30_desc: string
  badge_daily_checkin_100_name: string
  badge_daily_checkin_100_desc: string
  badge_pregnancy_first_log_name: string
  badge_pregnancy_first_log_desc: string
  badge_pregnancy_kicks_first_name: string
  badge_pregnancy_kicks_first_desc: string
  badge_pregnancy_kicks_week_name: string
  badge_pregnancy_kicks_week_desc: string
  badge_pregnancy_weight_first_name: string
  badge_pregnancy_weight_first_desc: string
  badge_pregnancy_weight_track_name: string
  badge_pregnancy_weight_track_desc: string
  badge_pregnancy_appt_first_name: string
  badge_pregnancy_appt_first_desc: string
  badge_pregnancy_appt_five_name: string
  badge_pregnancy_appt_five_desc: string
  badge_pregnancy_week_12_name: string
  badge_pregnancy_week_12_desc: string
  badge_pregnancy_week_27_name: string
  badge_pregnancy_week_27_desc: string
  badge_pregnancy_week_40_name: string
  badge_pregnancy_week_40_desc: string
  ...
  pregnancy_logSomething_label: string
  ...
  pregnancy_reminders_title: string
  ...
  pregnancy_weekRuler_cmValue: string
