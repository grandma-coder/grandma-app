...
import { VaccineScheduleTree } from './kids/VaccineScheduleTree'
import { VaccineTrackerSheet } from './kids/VaccineTrackerSheet'
...
export function KidsHome({ caregiverView }: KidsHomeProps = {}) {
  ...
  const WALLET_CARD_IDS = ['goals', 'vaccines', 'health', 'exams', 'diaper', 'growth_leap', 'reminders', 'memories', 'ask_grandma', 'rewards']
        ...
        return (
          <>
            <KidsWallet
              ...
              onOpenVaccines={() => setVaccinesVisible(true)}
